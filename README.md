...
List of community foundations (UK): http://ukcommunityfoundations.org/community_foundations/list
...
List of consumer organizations: https://en.wikipedia.org/wiki/List_of_consumer_organizations
...
* Hybrid
* Producer
* Retail Or Purchasing
* Social
* Worker

**Cooperative Home Care Associates** http://www.chcany.org/

List of cooperatives: https://en.wikipedia.org/wiki/List_of_cooperatives
...
LGBT rights organizations are civil rights, health, and community organizations created and existing to further the civil and human rights and health of sexual minorities and to improve the gay community. LGBT organizations may range from more moderate, liberal, organizations such as Stonewall (UK), to more outspoken organizations such as OutRage! in the U.K. and Bash Back! in the U.S., to the conservative, Log Cabin Republicans, in the U.S..	
...
Anyone making a positive contribution to society.
...
List of NGO's: https://www.ngoadvisor.net/top100ngos/
...
List of NPO's: https://topnonprofits.com/lists/best-nonprofits-on-the-web/
...
Lists of political parties: https://en.wikipedia.org/wiki/Lists_of_political_parties
...
List of international professional associations: https://en.wikipedia.org/wiki/List_of_international_professional_associations

##Religious Organizations

Religious activities generally need some infrastructure to be conducted. For this reason, there generally exist religion-supporting organizations, which are some form of organization that manage: the upkeep of places of worship, such as mosques, churches, temples, synagogues, chapels and other buildings or meeting places and the payment of salaries to religious leaders, such as Roman Catholic priests, Hindu priests, Christian ministers, imams and rabbis.

**Buddhist Society of Western Australia** https://bswa.org/

List of religious organizations: https://en.wikipedia.org/wiki/List_of_religious_organizations
...
* Credit Unions
* Development Trusts
* Fair Trade Or Ethical Businesses
...
List of social enterprises: https://en.wikipedia.org/wiki/List_of_social_enterprises
...
* Family Advocacy
* Family Planning
* Groups Challenging Capital Punishment
* Immigration Rights
* LGBT  Liberation
* Women’s Liberation
...
List of  social justice organizations: http://www.socialworkdegree.net/social-justice-organizations/

##Student Organizations

Student organizations are present in many colleges, universities, and high schools. In higher education, the students' union is often dedicated to social, organizational activities, representation, and academic support of the membership.
...
**Студэнцкая Рада** http://studrada.org
